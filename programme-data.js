...
window.NOULA_PROGRAMME = [
  ...
  { id:'market', time:'All day', start:'0000', room:'cour', cat:'Market', inAgenda:false, inGrid:true, people:[{n:'Noula team',img:'images/illustrations/makers-market.png'}],
    en:{t:"French Caribbean makers' market", d:'A marketplace of French Caribbean makers, crafts, food and community stalls, open right through the day.'},
    fr:{t:'Marché des créateurs antillais', d:"Un marché de créateurs antillais, artisanat, cuisine et stands communautaires, ouvert toute la journée."} },
  ...
  { id:'accras', time:'12h30 – 13h30', start:'1230', room:'cour', cat:'Workshop', tag:'Cooking', addon:'book', madrasBg:true, inAgenda:true, inGrid:true, people:[{n:'Noula kitchen',img:'images/gallery/accras-flyer.png',illo:true}],
  ...
  { id:'beguine', time:'14h00 – 15h30', start:'1400', room:'bal', cat:'Workshop', tag:'Dance', addon:'book', madrasBg:true, inAgenda:true, inGrid:true, people:[{n:'Joyce',img:'images/artists/joyce.png'}],
    en:{t:'Biguine initiation with Joyce', d:'Learn the steps of the biguine with Joyce. All levels welcome.'},
    fr:{t:'Initiation Biguine avec Joyce', d:'Apprenez les pas de la biguine avec Joyce. Tous niveaux bienvenus.'} },
  { id:'sorbet', time:'14h30 – 16h30', start:'1430', room:'cour', cat:'Kids', inAgenda:true, inGrid:true, people:[{n:'Fritz',img:'images/illustrations/sorbet.png'}],
  ...
  { id:'dominoes', time:'15h00 – 18h00', start:'1500', room:'cour', cat:'Tournament', addon:'book', madrasBg:true, inAgenda:true, inGrid:true, people:[{n:'Noula team',img:'images/illustrations/dominoes.png',illo:true}],
    en:{t:'Dominoes tournament', d:'The classic French Caribbean domino table, in a friendly tournament. Limited places, enter as an add-on.'},
    fr:{t:'Tournoi de dominos', d:'Le domino antillais, en tournoi convivial. Places limitées, inscrivez-vous en option.'} },
  { id:'belote', time:'15h00 – 18h00', start:'1500', room:'cour', cat:'Tournament', addon:'book', madrasBg:true, inAgenda:true, inGrid:true, people:[{n:'Noula team',img:'images/illustrations/belote.png',illo:true}],
    en:{t:'Belote tournament', d:'The belote card game, in a friendly tournament. Limited places, enter as an add-on.'},
    fr:{t:'Tournoi de belote', d:'La belote, en tournoi convivial. Places limitées, inscrivez-vous en option.'} },
  { id:'tales', time:'15h30 – 15h45', start:'1530', room:'bal', cat:'Storytelling', tbc:true, madrasBg:true, inAgenda:true, inGrid:true, people:[{n:'Ralphy',img:'images/artists/ralphy.png'}],
  ...
  { id:'kidoka1', time:'15h45 – 16h15', start:'1545', room:'cour', cat:'Kids', tbc:true, inAgenda:true, inGrid:true, people:[{n:'Noula team',img:'images/illustrations/kidoka.png'}],
  ...
  { id:'madras', time:'16h30 – 17h00', start:'1630', room:'cour', cat:'Workshop', tag:'Craft', addon:'book', madrasBg:true, tbc:true, inAgenda:true, inGrid:true, people:[{n:'Jade',img:'images/artists/jade.png'}],
  ...
  { id:'kidoka2', time:'17h15 – 17h45', start:'1715', room:'cour', cat:'Kids', tbc:true, inAgenda:true, inGrid:true, people:[{n:'Noula team',img:'images/illustrations/kidoka2.png'}],
  ...
  { id:'catwalk', time:'17h45 – 18h00', start:'1745', room:'bal', cat:'Carnival', tbc:true, madrasBg:true, inAgenda:true, inGrid:true, people:[{n:'UKM',img:'images/artists/ukm.png',illo:true}],
  ...
  { id:'zouk', time:'18h00 – 18h30', start:'1800', room:'bal', cat:'Dance', tbc:true, madrasBg:true, inAgenda:true, inGrid:true, people:[{n:'Lina',img:'images/zouklove-card.png',illo:true}],
  ...
  { id:'cn1', time:'18h30 – 19h15', start:'1830', room:'bal', cat:'Chante', madrasBg:true, inAgenda:true, inGrid:true, people:[{n:'Ziloka',img:'images/artists/ziloka.png',illo:true}],
  ...
  { id:'cn2', time:'19h35 – 20h20', start:'1935', room:'bal', cat:'Chante', madrasBg:true, inAgenda:true, inGrid:true, people:[{n:'Ziloka',img:'images/artists/ziloka.png',illo:true}],
  ...
  { id:'after', time:'20h30 – 22h20', start:'2030', room:'bal', cat:'DJ', madrasBg:true, inAgenda:true, inGrid:true, people:[{n:'DJ Djahman',img:'images/artists/djahman.png'}],
